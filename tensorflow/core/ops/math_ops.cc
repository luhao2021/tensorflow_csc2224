...
#define UNARY()                                                          \
  Input("x: T")                                                          \
      .Output("y: T")                                                    \
      .Attr(                                                             \
          "T: {bfloat16, cus, half, float, double, int8, int16, int32, " \
          "int64, "                                                      \
...
REGISTER_OP("IsNan")
    .Input("x: T")
    .Output("y: bool")
    .Attr("T: {bfloat16, cus, half, float, double}")
    .SetShapeFn(shape_inference::UnchangedShape);
...
#define BINARY_MORE()                                                        \
  Input("x: T").Input("y: T").Output("z: T").Attr(                           \
      "T: {bfloat16, cus, half, float, double, uint8, int8, uint16, int16, " \
      "int32, "                                                              \
...
REGISTER_OP("Add")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, cus, half, float, double, uint8, int8, int16, int32, "
        "int64, "
...
REGISTER_OP("AddV2")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, cus, half, float, double, uint8, int8, int16, uint32, "
        "int32, "
        "int64, complex64, complex128}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn)
    .SetIsAggregate()
...
REGISTER_OP("Maximum")
    ...
    .Input("y: T")
    .Output("z: T")
    .Attr("T: {bfloat16, cus, half, float, double, uint8, int16, int32, int64}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("Pow")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, cus, float, half, double, int32, int64, complex64, "
        "complex128}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
